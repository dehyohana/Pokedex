...
if(isset($_POST['submit'])){
    ...
    echo "<script>console.log('Usuário enviou a seguinte indicação de pokemon,
    Nome:'$nomePokemon, Id:$idPokemon, Peso:$pesoPokemon, Altura:$alturaPokemon, Habilidades:$habilidadesPokemon, Tipo:$tipoPokemon'); </script>";
}
...
<body>
    ...
    <header class="cabeçalho">
        <img class="cabeçalho-imagem" src="imagens/pokeball.png" onclick="window.location='index.html';">
